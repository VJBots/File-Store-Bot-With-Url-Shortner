...
class Config(object):
  ...
  BOT_USERNAME = os.environ.get("BOT_USERNAME", "ENO_1bot")
  DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002670171990"))
  ...
  BOT_OWNER = int(os.environ.get("BOT_OWNER", "7592041488"))
  ...
  UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002326767461")
  LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002303433343"))
